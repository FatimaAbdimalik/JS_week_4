...
function getOwnerFullName(house) {
  return `Owner of the kinningParkHouse: ${house.currentOwner.firstName} ${house.currentOwner.lastName}, Owner of the parkAvenueHouse: ${ house.currentOwner.firstName } ${ house.currentOwner.lastName }`
}

// returns an array of the owners' email addresses of the two houses
function getEmailAddresses(house1, house2) {
  let emails = [];
  emails.push(house1.currentOwner.email + ", " + house2.currentOwner.email)
  return emails
}
