...
let restaurantFinderApplication = {
    ...
    findRestaurantServingDish: function (dishName) {
        // Complete here
        return this.restaurants.filter(dishNameServed => dishNameServed.menu.includes(dishName))
        .map(restaurantName => restaurantName.name)
    },
    countNumberOfRestaurantsInArea: function (area) {
        // Complete here
        let restauArea = this.restaurants.filter(areaRestau => areaRestau.address.area === area);
        return restauArea.length
    }
};
